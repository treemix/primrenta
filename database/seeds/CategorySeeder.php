...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
            ...
            'courier' => array(
                ...
                'parent' => array(
                    'pedestrian' => array(
                        ...
                        'slug' => 'pedestrian',
                        'description' => 'Ищете курьера на день?',
                        'fields' => [
                            'dimensions' => [
                                'show' => true,
                            ...
                            'return_payment' => [
                                'show' => true,
                                'label' => 'Забрать у получателя оплату за товар и вернуть заказчику',
                                'hint' => 'Для заданий от интернет-магазинов.',
                            ],
                            'cargo_cost' => [
                                'show' => true,
                                'label' => 'Ценность посылки, руб',
                                'hint' => 'Это поможет найти исполнителей, готовых взяться за ваш заказ.',
                            ],
                            'description' => [
                                'placeholder' => 'Например: развезти небольшие пакеты по пяти адресам. Работа с 9:00 до 20:00, все адреса в пределах МКАДа.',
                                'hint' => 'Не забудьте указать: <br/>— Описание груза (что нужно доставить); <br/>— Габариты и вес груза; <br/>— Количество адресов; <br/>— Дата и время начала/завершения задания;<br/> — Дополнительные требования к курьеру?',
                            ],
                        ]
                    ),
                    'car' => array(
                        ...
                        'slug' => 'car',
                        'description' => 'Нужен курьер на авто?',
                        'fields' => [
                            'dimensions' => [
                                'show' => true,
                                'label' => 'Вес посылки, кг',
                            ...
                            'description' => [
                                'placeholder' => 'Например: отвезти по городу крупногабаритную посылку весом 30 кг. На своем автомобиле.',
                                'hint' => 'Не забудьте указать: <br/>— Описание груза (что нужно доставить); <br/>— Габариты и вес груза; <br/>— Количество адресов; <br/>— Дата и время начала/завершения задания;<br/> — Дополнительные требования к курьеру?',
                            ],
                        ]
                    ),
                    'courierbuyanddelivery' => array(
                        ...
                        'description' => 'Нужно купить и доставить цветы?',
                        'fields' => [
                            'dimensions' => [
                                'show' => true,
                                'label' => 'Вес посылки, кг',
                            ...
                            'description' => [
                                'placeholder' => 'Например: купить букет из 100 роз красного цвета и доставить в офис у ст. м. «Белорусская». Не говорить, от кого.',
                                'hint' => 'Не забудьте указать:<br/>— Что конкретно нужно купить;<br/>— Сумма покупки, условия оплаты;<br/>— При наличии, точный адрес места покупки;<br/>— Дата и время начала/завершения задания;<br/>— Дополнительные требования к курьеру?',
                            ],
                            'payment' => [
                                'show' => true
                            ]
                    ...
                    'expressdelivery' => array(
                        ...
                        'description' => 'Необходима срочная доставка по городу?',
                        'fields' => [
                            'dimensions' => [
                                'show' => true,
                                'label' => 'Вес посылки, кг',
                            ...
                            'description' => [
                                'placeholder' => 'Например: срочно доставить пакет документов, вес — менее 1 кг. Забрать у ст. м. «Выхино». Через 2 часа посылка должна быть у ст. м. «Красногвардейская».',
                                'hint' => 'Не забудьте указать: <br/>— Описание груза (что нужно доставить); <br/>— Габариты и вес груза; <br/>— Количество адресов; <br/>— Дата и время начала/завершения задания;<br/> — Дополнительные требования к курьеру?',
                            ],
                        ]
                    ),
                    'productsdelivery' => array(
                        ...
                        'description' => 'Нужно купить и доставить продукты из магазина?',
                        'fields' => [
                            'cargo_cost' => [
                                'show' => true,
                                'label' => 'Ценность посылки, руб',
                            ...
                            'description' => [
                                'placeholder' => 'Например: купить в магазине продукты для ужина. Список пришлю в чат. Стоимость — около 1000 рублей, всё уместится в один пакет. Доставить нужно ко мне домой к 18:00.',
                                'hint' => 'Не забудьте указать:<br/>— Что конкретно нужно купить;<br/>— Сумма покупки, условия оплаты;<br/>— При наличии, точный адрес места покупки;<br/>— Дата и время начала/завершения задания;<br/>— Дополнительные требования к курьеру?',
                            ],
                            'payment' => [
                                'show' => true
                    ...
                    'restaurantfooddelivery' => array(
                        ...
                        'description' => 'Нужно купить и доставить еду из ресторана?',
                        'fields' => [
                            'cargo_cost' => [
                                'show' => true,
                                'label' => 'Ценность посылки, руб',
                            ...
                            'description' => [
                                'placeholder' => 'Например: купить в кафе четыре большие пиццы и доставить к 17.00. Сумма покупки — примерно 2000 рублей, включена в стоимость задания.',
                                'hint' => 'Не забудьте указать:<br/>— Что конкретно нужно купить;<br/>— Сумма покупки, условия оплаты;<br/>— При наличии, точный адрес места покупки;<br/>— Дата и время начала/завершения задания;<br/>— Дополнительные требования к курьеру?',
                            ],
                            'payment' => [
                                'show' => true
                    ...
                    'regularcourier' => array(
                        'name' => 'Курьер на день',
                        'slug' => 'regularcourier',
                        'description' => 'Нужна регулярная доставка курьером?',
                        'fields' => [
                            'dimensions' => [
                                'show' => true,
                                'label' => 'Вес посылки, кг',
                            ...
                            'description' => [
                                'placeholder' => 'Например: отвезти документы в головной офис из филиала компании. Пеший курьер с опытом работы от года.',
                                'hint' => 'Не забудьте указать: <br/>— Описание груза (что нужно доставить); <br/>— Габариты и вес груза; <br/>— Количество адресов; <br/>— Дата и время начала/завершения задания;<br/> — Дополнительные требования к курьеру?',
                            ],
                            'courier_transport' => [
                                'show' => true
                    ...
                    'courierother' => array(
                        'name' => 'Другая посылка',
                        'slug' => 'courierother',
                        'description' => 'Ищете быстрого и надежного курьера?',
                        'default' => true,
                        'fields' => [
                            'dimensions' => [
                                'show' => true,
                            ...
                            'description' => [
                                'placeholder' => 'Например: развезти 10 небольших пакетов по 5 адресам. Общий вес — не более 7 кг. Желательно успеть доставить все пакеты за один день.',
                                'hint' => 'Не забудьте указать: <br/>— Описание груза (что нужно доставить); <br/>— Габариты и вес груза; <br/>— Количество адресов; <br/>— Дата и время начала/завершения задания;<br/> — Дополнительные требования к курьеру?',
                            ],
                        ]
                    )
        ...
        foreach ($categories_arg as $item){
            ...
            $cat->fields = isset($item['fields']) ? json_encode($item['fields']) : "";
            $cat->save();
            if(!empty($item['parent'])){
                foreach ($item['parent'] as $item_parent){
                    ...
                    $cat_parent->fields = isset($item_parent['fields']) ? json_encode($item_parent['fields']) : "";
                    $cat_parent->save();
                }
            }
        }
