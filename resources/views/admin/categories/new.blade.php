            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <form class="form-horizontal" method="POST" action="{{route('admin.categories.post.new')}}">
                        <input type="hidden" name="parent_id" value="{{ old('parent_id') ? old('parent_id') : 0 }}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-success float-right" style="min-width: 150px;">Create</button>
                        </div>
                        <!-- /.card-footer -->
                    </div>
                    </form>
